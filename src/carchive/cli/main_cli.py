...
from carchive.cli.server_cli import app as server_app  # Import the Server Management CLI
...
main_app.add_typer(server_app, name="server")  # Add the Server Management CLI
