"""
OpenAI implementation of content agent.
"""
...
class OpenAIContentAgent(BaseContentAgent):
    """OpenAI implementation of content processing capabilities."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize the OpenAI content agent.
        ...
        # Use the OpenAI chat agent for actual interactions
        self._chat_agent = OpenAIChatAgent(
            api_key=api_key,
